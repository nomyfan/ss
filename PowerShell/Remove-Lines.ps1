...
PSVersion: 5.1
----------------------------------------------------------------------------------
This script is used to remove the Nth lines before a line starts with special words.
...
$dir = $Diretory + "\*"
$files = Get-ChildItem -Path $dir -Filter $Filter -Include $Include -Exclude $Exclude -Recurse
